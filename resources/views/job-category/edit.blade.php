      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
        <div class="p-8 text-gray-900">
          <h3 class="text-lg font-semibold mb-6">
            {{ __("Edit the job category") }}
          </h3>

          <form action="{{ route('job-categories.update', $jobCategory->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
              ...
              <x-text-input id="name"
                ...
                type="text" name="name" :value="old('name', $jobCategory->name)" required autofocus />
              @error('name')
