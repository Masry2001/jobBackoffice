        ...
        <div class="p-8 text-gray-900">
          ...
          <form
            ...
            <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shasow-sm">
              ...
              <div class="mb-4">
                ...
                <x-text-input id="title"
                  ...
                  type="text" name="title" :value="old('title', $jobVacancy->title)" required autofocus />
                @error('title')
              ...
              <div class="mb-4">
                ...
                <x-text-input id="location"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                  type="text" name="location" :value="old('location', $jobVacancy->location)" required autofocus />
                @error('location')
              ...
              <div class="mb-4">
                ...
                <x-text-input id="salary"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                  type="number" name="salary" :value="old('salary', $jobVacancy->salary)" autofocus />
                @error('salary')
              ...
              <div class="mb-4">
                ...
                <textarea id="description" rows="4"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                  name="description" required autofocus>{{ old('description', $jobVacancy->description) }}</textarea>
                @error('description')
              ...
              <div class="mb-4">
                ...
                <select name="type" id="type"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg">
                  <option value="Full-Time" @if (old('type', $jobVacancy->type) == 'Full-Time') selected @endif>Full-Time
                  </option>
                  <option value="Contract" @if (old('type', $jobVacancy->type) == 'Contract') selected @endif>Contract
                  </option>
                  <option value="Remote" @if (old('type', $jobVacancy->type) == 'Remote') selected @endif>Remote</option>
                  <option value="Hybrid" @if (old('type', $jobVacancy->type) == 'Hybrid') selected @endif>Hybrid</option>
                </select>
                @error('type')
              ...
              <div class="mb-4">
                ...
                <select name="companyId" id="companyId"
                  ...
                  @foreach ($companies as $company)
                    <option value="{{ $company->id }}" @if (old('companyId', $jobVacancy->companyId) == $company->id)
              ...
              <div class="mb-4">
                ...
                <select name="jobCategoryId" id="jobCategoryId"
                  ...
                  @foreach ($jobCategories as $jobCategory)
                    <option value="{{ $jobCategory->id }}" @if (old('jobCategoryId', $jobVacancy->jobCategoryId) == $jobCategory->id) selected @endif>{{ $jobCategory->name }}
                    </option>
                  @endforeach
            ...
            <div class="flex justify-end items-center space-x-3 pt-4 border-t border-gray-200">
              <x-link :href="route('job-vacancies.show', $jobVacancy->id)">
                {{ __('Cancel') }}
              </x-link>
