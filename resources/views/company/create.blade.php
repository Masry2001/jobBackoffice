            ...
            <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shasow-sm">
              ...
              <div class="mb-4">
                ...
                <x-text-input id="website"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                  type="text" name="website" :value="old('website')" autofocus />
                @error('website')
            ...
            <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shasow-sm">
              ...
              <div class="mb-4">
                ...
                <x-text-input id="owner_name"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                  type="text" name="owner_name" :value="old('owner_name')" required autofocus />
                @error('owner_name')
              ...
              <div class="mb-4">
                ...
                <x-text-input id="owner_email"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                  type="text" name="owner_email" :value="old('owner_email')" required autofocus />
                @error('owner_email')
